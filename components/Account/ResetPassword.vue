            ...
            <v-row>
                ...
                <v-col cols="12" sm="8" md="8" class="-mt-3">
                    ...
                    <form @submit.prevent="changePassword()" ref="formResetPassword">
                        ...
                        <v-text-field :type="isPasswordVisible2 ? 'text' : 'password'" :append-icon="isPasswordVisible2 ? `mdi-eye-off-outline` : `mdi-eye-outline`" @click:append="isPasswordVisible2= !isPasswordVisible2" required class="w-full md:w-1/2 m-1"  v-model="form.password_confirm" prepend-inner-icon="em em-closed_lock_with_key" label="New Password Confirm" dense outlined></v-text-field>
