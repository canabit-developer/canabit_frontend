...
<!--                      <v-alert v-if="(form.password != form.password_confirm) && (form.password != '' && form.password_confirm != '')" type="error">Password and Password Confirm not match!</v-alert>-->
                        <v-text-field  :type="isPasswordVisible ? 'text' : 'password'" prepend-inner-icon="em em-closed_lock_with_key" v-model="form.password" required color="primary" outlined hint="*  Please Enter Password" label="Password" :append-icon="isPasswordVisible ? `mdi-eye-off-outline` : `mdi-eye-outline`" @click:append="isPasswordVisible = !isPasswordVisible"  class="mb-3"></v-text-field>
                        <v-text-field :type="isPasswordVisible2 ? 'text' : 'password'" prepend-inner-icon="em em-closed_lock_with_key" v-model="form.password_confirm" required color="primary" outlined hint="*  Please Enter Confirm Password" label="Confirm Password" :append-icon="isPasswordVisible2 ? `mdi-eye-off-outline` : `mdi-eye-outline`" @click:append="isPasswordVisible2 = !isPasswordVisible2"  class="mb-3"></v-text-field>
